...
* [How to Unmarshal an Array of JSON Objects of Different Types into a Go Struct](https://medium.com/@alain.drolet.0/how-to-unmarshal-an-array-of-json-objects-of-different-types-into-a-go-struct-10eab5f9a3a2)
* [Why should you learn Go?](https://medium.com/@kevalpatel2106/why-should-you-learn-go-f607681fad65)
* [Publishing Go Modules](https://blog.golang.org/publishing-go-modules)
* [Go Modules from the private repository in the pipeline](https://medium.com/@ikolomiyets/go-modules-from-the-private-repository-in-the-pipeline-5921d3ba0e40)
* [Simple Guide to Panic Handling and Recovery in Golang](https://medium.com/swlh/simple-guide-to-panic-handling-and-recovery-in-golang-72d6181ae3e8)